...
class TestIDyOMExperiment(TestCase):
    ...
    # def test_case_1_lisp_commands(self):
    #     """Test case 1:
    #     target_viewpoints='(cpitch), source_viewpoints='((cpintfref cpint) ioi)
    #     model=stm, stmo=stmo, order_bound=5, k = 2, detail=3
    #     """
    #
    #     test_dataset_path = '/Users/xinyiguan/Codes/py2lispIDyOM/tests/dataset/bach_dataset/'
    ...
    #                                     source_viewpoints=[('cpintfref', 'cpint'), 'ioi'],
    #                                     models=':stm',
    #                                     stmo=':stmo',
    #                                     stmo_order_bound=5,
    #                                     k=2,
    ...
    #                         f'(idyom:idyom {test_dataset_id} \'(cpitch) \'((cpintfref cpint) ioi) :models :stm :stmo ' \
    ...
    def test_case_2_lisp_commands(self):
        """Test case 1:
        target_viewpoints='(cpitch), source_viewpoints='((cpintfref cpint) ioi)
        ...
        # test_dataset_path = '/Users/xinyiguan/Codes/py2lispIDyOM/tests/dataset/bach_dataset/'
        # pretrain_dataset_path = '/Users/xinyiguan/Codes/py2lispIDyOM/tests/dataset/shanx_dataset/'
        ...
        expected_commands = f'(start-idyom)\n' \
                            ...
                            f'(idyom:idyom {test_dataset_id} \'(cpitch) \'((cpintfref cpint) ioi) :models :both :ltmo ' \
